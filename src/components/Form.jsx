...
const Form = () => {
        ...
        const handleSubmit = async(e) => {
          ...
          try {
           await emailjs.send(
               ...
               {
               from_name: form.name,
               to_name: 'Duru Pristine', 
               from_email: form.email,
               to_email:'favourduru24@gmail.com',
  ...
  return (
    <section className='sm:px-10 px-5 my-20 min-h-screen p-1' id='contact'>
         ...
         <div className='col-span-2 relative w-full h-[100vh] max-lg:col-span-1'>
         ...
         <div className='bg-[#1C1C21] border-[#1C1C21]  min-h-screen rounded-l-2xl absolute top-0 right-0 w-[50%] max-lg:w-full flex flex-col backdrop-blur-3xl items-center justify-center'>
         <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col space-y-7 px-10 '>
